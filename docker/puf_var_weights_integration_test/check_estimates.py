...
print(f"2024 income tax sum is {sim.calculate("income_tax", 2024).sum() / 1E9:.2f} Billion USD")
print(f"2024 farm income sum is {sim.calculate("farm_income", 2024).sum() / 1E9:.2f} Billion USD")
